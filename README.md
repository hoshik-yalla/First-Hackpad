...
## Usage
**DeskBud** is a hackpad designed to help programmers in VS Code. Instead of navigating menus or remembering keyboard shortcuts, users can press dedicated keys to launch frequently used actions.
